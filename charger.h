...
class Charger {
  ...
  private:
    ...
    long s1MinRestMillis = 20000; //0.9.9.53
    long s2MinRestMillis = 5000; //0.9.9.53
    ...
    long wait_excess_power_start_millis = 5000; //Solange muss ein Ueberangebot an Solarstrom herrschen, bevor S1 angeschaltet wird, v.1.0.7
